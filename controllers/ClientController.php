...
//    }
    ...
    public function actionIndex()
    {
        ...
        if (count($filter) <= 1) {
          $filter = Yii::$app->session['clientparams'];
          if(isset(Yii::$app->session['clientparams']['page']))
            $_GET['page'] = Yii::$app->session['clientparams']['page'];
          } else {
            Yii::$app->session['clientparams'] = $filter;
        }
